...
# (assuming the folder with this setup script has been moved to a directory "Scripts" which is located in the "Desktop" directory)
cp ~/Scripts/s/wallpapers/wallpaper.png ~/.config/sway/wallpapers/wallpaper.png
...
exec_always swaybg -i ~/.config/sway/wallpapers/wallpaper.png -m fill
